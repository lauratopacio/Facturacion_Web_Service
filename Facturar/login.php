...
$consulta = "SELECT id_login from login where username =:usu"; 
$result = $db->prepare($consulta);
$result->execute(array(":usu" => $usuario));
$resultado_usuario = $result->fetchColumn();         
  

$detalle= "INSERT INTO detalle_usuario(id_login) VALUES('".$resultado_usuario."')";
